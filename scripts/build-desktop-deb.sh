...
""")
    ...
    z.writestr(f"{di}/entry_points.txt", "[console_scripts]\npanxcz-tools = panxcz_tools.cli:main\npanxcz-tools-tui = panxcz_tools.tui:main\n")
    z.writestr(f"{di}/top_level.txt", "panxcz-tools\n")
...
Description: R2OFRAK - Unified Reverse Engineering Platform
 ...
 Run 'panxcz-tools-tui' for interactive mode or 'panxcz-tools --help' for CLI.
EOF
